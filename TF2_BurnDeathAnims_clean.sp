...
{
	new deathAnims = GetConVarInt(burnAnim);
	...
	new sillyDeath = GetConVarInt(sillyDeaths);
	...
	{}else if (sillyDeath == 0 && (victimClass == TFClass_Scout || victimClass == TFClass_DemoMan)){}else{ //For Silly deaths turned off
